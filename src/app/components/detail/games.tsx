...
export const Games = () => {
    return (
        <>
            <div className="bg-gray-900 text-white mt-10 rounded-2xl relative mx-4 p-4 sm:text-xs">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2  gap-4 md:gap-6 lg:gap-8 my-5">
                    <div className=' flex justify-between items-center'>
                        <div className="flex rounded-xl items-center gap-2">
                            <img className="rounded-2xl" src="/image/game-01.jpg" alt="popular image" />
                        ...
                        <div className=" space-y-2 ">
                            ...
                            <h6 className="flex items-center text-xs gap-1">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-4 h-4 sm:text-xs">
                    ...
                    <div className=' flex justify-between items-center'>
                        <div className="flex rounded-4xl items-center gap-2">
                            <img className="rounded-2xl" src="/image/game-02.jpg" />
                            <div className="space-y-2">
                                <h6 className="text-xs">Fortnite</h6>
                                <h6 className="text-xs flex items-center">Sandbox</h6>
                            </div>
                    ...
                    <div className=' flex justify-between items-center '>
                        <div className="flex rounded-xl items-center gap-2">
                            <img className="rounded-2xl" src="/image/game-03.jpg" alt="popular image" />
                            <div className="space-y-2">
                                <h6 className="text-xs">Fortnite</h6>
                                <h6 className="text-xs flex items-center">Sandbox</h6>
                            </div>
                    ...
                    <div className=' flex justify-between items-center'>
                        <div className="flex rounded-4xl items-center gap-2">
                            <img className="rounded-2xl" src="/image/game-03.jpg" />
                            <div className="space-y-2">
                                <h6 className="text-xs">Fortnite</h6>
                                <h6 className="text-xs flex items-center">Sandbox</h6>
                            </div>
                    ...
                    <div className=' flex justify-between items-center'>
                        <div className="flex rounded-xl items-center gap-2">
                            <img className="rounded-2xl" src="/image/game-02.jpg" alt="popular image" />
                            <div className="space-y-2">
                                <h6 className="text-xs">Fortnite</h6>
                                <h6 className="text-xs flex items-center">Sandbox</h6>
                            </div>
                    ...
                    <div className=' flex justify-between items-center'>
                        <div className="flex rounded-4xl items-center gap-2">
                            <img className="rounded-2xl" src="/image/game-01.jpg" />
                            <div className="space-y-2">
                                <h6 className="text-xs">Fortnite</h6>
                                <h6 className="text-xs flex items-center">Sandbox</h6>
                            </div>
